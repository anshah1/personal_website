...
const experiences: Experience[] = [
    {
        ...
        description: "At DraftKings, I interned on the AI Platforms Beta team, working on DraftCode, DraftKings' agentic PR reviewer and compliance tool. My first project let teams define LLM skills files inside their own repositories, encoding team-specific review instructions that DraftCode executes through subagents. My second project exposed DraftCode's engine as an API, so teams could use it outside of Bitbucket pull requests. Alongside both, I helped onboard teams onto the features I shipped.",
        location: 'Boston, MA',
        logo: dkLogo,
